...
Auth Service supports optional Stripe billing integration using the Stripe API version `2026-05-27.dahlia`. When configured, Stripe product and price IDs on subscription plans are used to reconcile plan status via webhook events.
