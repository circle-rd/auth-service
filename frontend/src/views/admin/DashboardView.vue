...
<template>
    <div class="space-y-6">
        ...
        <div>
            ...
            <p class="text-sm mt-1" style="color: var(--text-muted)">Vue d'ensemble du service d'authentification</p>
        </div>
        ...
        <div class="kpi-grid">
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-body">
                    <p class="kpi-label">Sessions actives</p>
                    <p class="kpi-value">
                        <span v-if="loading" class="kpi-loading" />
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-body">
                    <p class="kpi-label">Utilisateurs bannis</p>
                    <p class="kpi-value">
                        <span v-if="loading" class="kpi-loading" />
        ...
        <div class="card !p-0 overflow-hidden">
            <div class="flex items-center justify-between px-5 py-4" style="border-bottom: 1px solid var(--border)">
                <div class="flex items-center gap-2">
                    <Clock class="w-4 h-4" style="color: var(--accent-cyan)" />
                    <h2 class="text-sm font-semibold">Sessions récentes</h2>
                </div>
                <span class="text-xs" style="color: var(--text-muted)">10 dernières</span>
            </div>

            <div v-if="loading" class="px-5 py-10 text-center text-sm" style="color: var(--text-muted)">
                {{ t("common.loading") }}
            </div>
            ...
            <div v-else class="overflow-x-auto">
                <table class="w-full text-sm">
                    <thead>
                        <tr style="border-bottom: 1px solid var(--border)">
                            <th class="text-left px-5 py-3 text-xs font-medium uppercase tracking-wide"
                                style="color: var(--text-muted)">Utilisateur</th>
                            ...
                            <th class="text-left px-5 py-3 text-xs font-medium uppercase tracking-wide hidden md:table-cell"
                                style="color: var(--text-muted)">Navigateur</th>
                            <th class="text-left px-5 py-3 text-xs font-medium uppercase tracking-wide"
                            ...
                            <td class="px-5 py-3">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs" style="color: var(--text-muted)">{{ s.userEmail }}</p>
                                    </div>
                                </div>
                            </td>
                  ...
                  {{ s.ipAddress ?? "—" }}
                            ...
                            <td class="px-5 py-3 hidden md:table-cell text-xs" style="color: var(--text-muted)">
                                {{ parseUA(s.userAgent) }}
                            </td>
