const en = {
  ...
  auth: {
    ...
    mfaAutoHint: "Verification is automatic when all digits are entered.",
    totpLabel: "Authenticator code",
    totpPlaceholder: "6-digit code",
    verifyCode: "Verify code",
    useHardwareKey: "Use hardware key instead",
    passkeyHint: "Touch your hardware key when prompted by your browser to authenticate.",
    authenticateWithKey: "Authenticate with hardware key",
  ...
  consent: {
    ...
    authEntityRole: "Identity provider",
    appEntityRole: "Requesting application",
    scopes: "Permissions shared",
    allow: "Allow access",
    deny: "Deny",
    legal: "You can revoke this access at any time from your profile settings.",
    scope: {
